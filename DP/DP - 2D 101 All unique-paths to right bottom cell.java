...
2 You also need to realise
	...
	******** Lesson Learnt *********
	...
	come up with the algorithm .... and
		- try 0 value would that work with genral algorithm? ( wors if you adding or subtracting
			- yes, then try some corner cases
		- try 1, that may help in division/multiplication
			- yes, then try some corner cases
*/
